...
class ResnetGenerator(nn.Module):
    ...
    def __init__(self, input_nc, output_nc, ngf=64, norm_layer=nn.BatchNorm2d, use_dropout=False, n_blocks=6, padding_type='reflect', no_antialias=False, no_antialias_up=False, opt=None):
        ...
        #self.ContendEncoder = nn.Sequential(*model)
    ...
    def forward(self, input, layers=[], encode_only=False, content_only = False):
        if -1 in layers:
        ...
        #     content_layers.append(len(self.ContentEncoder))
        ...
        #     for layer in self.ContentEncoder:
        #         content = layer(content)

        #         if content_layer_id in content_layers:
        #             contents.append(content)
        #         else:
        #             pass
        #         if content_layer_id == content_layers[-1]:
        #             if encode_only and content_only:
        #                 return content, None
        #         content_layer_id +=1
