...
class Visualizer():
    ...
    def __init__(self, args):
        ...
        """
        self.opt = args  # cache the option
        ...
        self.use_html = args.mode == 'train' and not args.no_html
        ...
        if self.use_html:  # create an HTML object at <checkpoints_dir>/web/; images will be saved under <checkpoints_dir>/web/images/
            self.web_dir = os.path.join(args.checkpoint_dir, args.name, 'web')
            self.img_dir = os.path.join(self.web_dir, 'images')
            print('create web directory %s...' % self.web_dir)
            util.mkdirs([self.web_dir, self.img_dir])
        # create a logging file to store training losses
        self.log_name = os.path.join(args.checkpoint_dir, args.name, 'loss_log.txt')
